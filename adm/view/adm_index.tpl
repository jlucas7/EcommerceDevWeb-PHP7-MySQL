    ...
    <div class="container-fluid">
        ...
        <div class="row" id="topo">
            ...
            <div class="container" id="container_logon">
                ...
                <!-- <div class="col-md-6">
                         <img src="{$GET_TEMA}/images/bg.png" alt=""> 
                    </div>-->
                ...
                <div class="col-md-6 text-right">
                    ...
                    Olá: {$USER} <a href="{$PAG_LOGOFF}" class="btn btn-info"><i
                            class="glyphicon glyphicon-log-out"></i> Sair </a>

                    <a href="{$PAG_SENHA}" class="btn btn-warning"><i class="glyphicon glyphicon-asterisk"></i>Alterar
                        Senha </a> <br><br>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{$PAG_CATEGORIAS}"><i class="glyphicon glyphicon-tag"></i> Categorias </a>
                            </li>

                            <li><a href="{$PAG_ADM_PRODUTOS}"><i class="glyphicon glyphicon-user"></i> Produtos </a>
                            </li>

                            <li><a href="{$PAG_ADM_CLIENTE}"><i class="glyphicon glyphicon-shopping-cart"></i> Clientes
                                </a> </li>

                            <li><a href="{$PAG_ADM_PEDIDOS}"><i class="glyphicon glyphicon-envelope"></i> Pedidos </a>
                            </li>
        ...
        <div class="row" id="rodape">
            <center>
                <h4>{$TITULO_SITE}</h4>
                <P><b>Descrições<b> - Data atual: {$DATA}</P>
            </center>
