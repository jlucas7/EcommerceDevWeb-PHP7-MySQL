    ...
    <div class="container-fluid">
        ...
        <div class="row" id="topo">
            ...
            <div class="container" id="container_logon">
                ...
                <!--<div class="col-md-6">
                         <img src="{$GET_TEMA}/images/nada.png" alt=""> 
                    </div> -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{$PAG_MINHACONTA}"><i class="glyphicon glyphicon-user"></i> Minha Conta </a>
                            </li>
                            <li><a href="{$PAG_CARRINHO}"><i class="glyphicon glyphicon-shopping-cart"></i> Carrinho
                                </a> </li>
                        ...
                        <form class="navbar-form navbar-right" role="search" method="POST" action="">
                            <div class="form-group">
                                <input type="text" name="txt_buscar" class="form-control"
