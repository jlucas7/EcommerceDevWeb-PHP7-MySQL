...
if (!$calc):
	...
	foreach ($frete->frete as $frete):
		...
		if ($frete['erro'] != 0):
			...
			echo '<br><br><b>Mensagem: oops, a página do Correios apresenta erros para calculo neste CEP! <P>Mas entre em contato conosco agora mesmo para finalizarmos a entrega!</P></b><br><br>';
